# -*- coding: utf-8 -*-
"""
main_06_generate_GAN_training_data.py
...
sensor_names_orig = ['T24', 'T30', 'T50', 'P30', 'Nf', 'Nc', 'Ps30', 'phi', 'NRf', 'NRc', 'BPR', 'htBleed', 'W31', 'W32']
sensor_names_orig = ['T24', 'T30', 'T50', 'P30', 'Nf', 'Nc', 'Ps30', 'phi', 'NRf', 'NRc', 'BPR', 'htBleed', 'W31', 'W32']
sensor_names_orig  =['BPR']
for selected_sensor_name in sensor_names_orig:
    ...
    for sample_index in range(nr_samples):
        ...
        increasing_trend = increasing_trend_dic[sensor_name] or True
        ...
        noise_level = max(0.1, noise_dist_dic[sensor_name].sample()[0])
        signal = []
        ...
        if True or show_synthetic_data:
    ...
    noisy_dir_name = './training_data2/' + sensor_name + '/GAN_noisy_signals.npy'
    pure_dir_name = './training_data2/'  + sensor_name + '/GAN_pure_signals.npy'
    print('Writing ',  nr_samples , noisy_dir_name, pure_dir_name)
    np.save(pure_dir_name, samples, allow_pickle=True)
    # Save data to file for re-use
    np.save(noisy_dir_name, noisy_samples, allow_pickle=True)
