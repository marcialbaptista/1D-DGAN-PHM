...
for sensor_name_simulated in sensor_names:
    ...
    ax=None
    if show_slope_densities:
        ax = data.plot(kind='hist', bins=30, density=True, alpha=0.25, label='Data [1]', color='black')
        # Save plot limits
        dataYLim = ax.get_ylim()
    dist_str, best_fit_dist_params = best_fit_distribution(data, 10, ax)
