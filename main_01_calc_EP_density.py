# -*- coding: utf-8 -*-
"""
main_01_calc_EP_density.py

Calculates the density function of the length of the healthy stage
(elbow point EP or inflection point IP location).
...
line_styles = ['-', '--', ':'	]
select_dist_names = ['Burr', 'Exponential Weibull', 'Johnson SU']
...
for proper_dist_name, dist_name, linestyle in zip(select_dist_names, dist_names, line_styles):
    ...
    param = dist.fit(y)
    print('Parameters: ', param, dist_name)
...
dist_parameters.to_csv('./data_models/elbow_point_density.csv')
print('\n* Written ./data_models/elbow_point_density.csv')
print('* Successful end of script to find elbow point (or inflection point) distribution')
